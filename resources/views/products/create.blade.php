    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
          ...
          <div class="form-group">
              ...
              <input type="search" id="providers_id" name="providers_id" class="form-control" placeholder="Inserir a id do Fornecedor do Produto:...">
          </div>
          <div class="form-group">
              <label for="brands_id">Marca</label>
              <input type="text" id="brands_id" name="brands_id" class="form-control" placeholder="Inserir a id da Marca do Produto:...">
          </div>
          <div class="form-group">
              <label for="categories_id">Categoria</label>
              <input type="search" id="categories_id" name="categories_id" class="form-control" placeholder="Inserir a id da Categoria do Produto:...">
          </div>
        </div>  
